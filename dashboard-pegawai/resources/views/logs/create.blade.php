...
@section('contents')
    <div class="p-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-4">Tambah Log Kegiatan</h1>
            ...
            <form action="{{route('logs.store')}}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <input type="text" id="deskripsi" name="deskripsi" required class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Masukkan nama kegiatan">
                    </div>
